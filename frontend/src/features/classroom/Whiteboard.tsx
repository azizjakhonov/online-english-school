          ...
          <div className="flex items-center gap-1 px-1">
            {COLORS.map((c) => (
              <button
                ...
                className={`w-5 h-5 rounded-full transition-all ring-offset-1 ${color === c
...
function ToolBtn({
  ...
  return (
    <button
      onClick={onClick}
      title={title}
      className={`p-2 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-1 ${active
...
export default memo(WhiteboardInner);
