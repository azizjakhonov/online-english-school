            ...
            <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-4 flex items-center gap-4 sticky top-0 z-20">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-500 font-medium">View and edit your account</p>
                    </div>
                </div>
            </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 text-center">
                            ...
                            {avatarError && (
                                <p className="text-xs text-red-700 bg-red-50 border border-red-200 rounded-xl px-3 py-2 mb-2 text-center font-medium">
                                    {avatarError}
                                </p>
                            )}
                            ...
                            {isEditing ? (
                                ...
                                <div className="space-y-3 text-left mt-3">
                                    ...
                                    {saveMessage?.type === 'error' && (
                                        <p className="text-xs text-red-700 bg-red-50 border border-red-200 rounded-xl px-3 py-2 text-center font-medium">
                                            {saveMessage.text}
                                        </p>
                                    )}
                                ...
                                <>
                                    ...
                                    {saveMessage?.type === 'success' && (
                                        <p className="mt-3 text-xs text-green-700 bg-green-50 border border-green-200 rounded-xl px-3 py-2 text-center font-medium">
                                            {saveMessage.text}
                                        </p>
                                    )}
                        ...
                        <div className="bg-slate-900 text-white rounded-2xl p-6 shadow-sm border border-slate-800 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-4xl font-black mb-6">{currentUser.student_profile?.available_credits ?? currentUser.student_profile?.lesson_credits ?? 0} <span className="text-lg font-medium text-slate-400">Credits</span></h3>
                                <button
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 min-h-[500px] flex flex-col">
                            ...
                            <div className="flex items-center border-b border-slate-200 p-2">
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-bold text-sm transition-colors ${activeTab === 'lessons' ? 'bg-blue-600 text-white' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700'}`}
                                >
                                    <History size={18} /> Lesson History
                                </button>
                                <button
                                    onClick={() => setActiveTab('billing')}
                                    className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-bold text-sm transition-colors ${activeTab === 'billing' ? 'bg-blue-600 text-white' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700'}`}
                                >
...
function EmptyHistory({ icon, text }: { icon: React.ReactNode, text: string }) {
    return (
        <div className="p-16 text-center">
            <div className="mb-4 text-slate-300 [&>svg]:mx-auto [&>svg]:block [&>svg]:text-slate-300">{icon}</div>
            <h3 className="text-lg font-bold text-slate-900 mb-1">Nothing here yet</h3>
